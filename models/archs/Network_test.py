...
from models.archs.modules_test import DDRB_Traceable, TraceLayer, extract_all_trace_data, ERPAB_Traceable
...
class DPENet_Traceable(nn.Module):
    def __init__(self,
        ...
        # ERPAB_Traceable
        self.erpab = ERPAB_Traceable(in_channels = in_channels,
                                     mid_channels = mid_channels,
                                     kernel = kernel, stride = stride,
                                     d = dilation_list, bias=bias)
    ...
    def forward(self, x, trace=False):
        ...
        # trace ERPAB
        output, features_erpab = self.erpab(x)
